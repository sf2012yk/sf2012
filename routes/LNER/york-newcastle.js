...
const CP_York1_Un = resamplePath(CP_York1, 12);
...
const CP_York2_Un = resamplePath(CP_York2, 5);
...
const CP_HuttonBonville_Un = resamplePath(CP_HuttonBonville, 6);
...
const CP_DaltononTees_Un = resamplePath(CP_DaltononTees, 12);
//カーブ南東//
...
const CP_CroftonTees_Un = resamplePath(CP_CroftonTees, 8);
...
const CP_SaltersLn_Un = resamplePath(CP_SaltersLn, 9);
...
const CP_Brafferton_Un = resamplePath(CP_Brafferton, 7);
//カーブ南西//
...
const CP_LimeLnDr_Un = resamplePath(CP_LimeLnDr, 7);
//カーブ北西//
...
const CP_AycliffeVl_Un = resamplePath(CP_AycliffeVl, 5);
//カーブ北東//
...
const CP_RicknallLn_Un = resamplePath(CP_RicknallLn, 6);
//カーブ南東//
...
const CP_PrestonLeSkerne_Un = resamplePath(CP_PrestonLeSkerne, 11);
//カーブ北東//
...
const CP_Bradbury_Un = resamplePath(CP_Bradbury, 8);
//カーブ北東//
...
const CP_ThrundleFarm_Un = resamplePath(CP_ThrundleFarm, 5);
//カーブ北西//
...
const CP_GhipslyLn_Un = resamplePath(CP_GhipslyLn, 7);
//カーブ南西//
...
const CP_Mainsforth_Un = resamplePath(CP_Mainsforth, 8);
...
const CP_HettSouth_Un = resamplePath(CP_HettSouth, 12);
//カーブ北西//
...
const CP_HettNorth_Un = resamplePath(CP_HettNorth, 6);
...
const CP_BrowneyLn_Un = resamplePath(CP_BrowneyLn, 9);
...
const CP_NevillesCross_Un = resamplePath(CP_NevillesCross, 8);
...
const CP_Durham_Un = resamplePath(CP_Durham, 5);
...
const CP_NewtonHall_Un = resamplePath(CP_NewtonHall, 10);
...
const CP_ChesterMoor_Un = resamplePath(CP_ChesterMoor, 5);
...
const CP_Waldridge_Un = resamplePath(CP_Waldridge, 5);
...
const CP_HighFlatts_Un = resamplePath(CP_HighFlatts, 5);
//カーブ北東//
...
const CP_Birtley_Un = resamplePath(CP_Birtley, 5);
...
const CP_Saltwell_Un = resamplePath(CP_Saltwell, 5);
//カーブ北西//
